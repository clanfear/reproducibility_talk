...
subtitle: "Organization, Tools, and Best Practices"
author: "Chuck Lanfear"
date: "May 31, 2019<br>Updated: `r gsub(' 0', ' ', format(Sys.Date(), format='%b %d, %Y'))`"
output:
...
[`bookdown`](https://bookdown.org/yihui/bookdown/) for R—which is integrated into `rrtools`—can generate documents in the proper format for articles, theses, books, or dissertations.
